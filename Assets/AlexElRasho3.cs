...
public class AlexElRasho3 : MonoBehaviour
{
    ...
    void Update()
    {
        transform.localScale = Vector3.Scale(transform.localScale, new Vector3( (alexBolitas.size * 23 > 0 ? alexBolitas.size * 23 : 1) / sx,1,1));
